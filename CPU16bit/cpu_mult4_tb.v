`timescale 1ns / 1ps
//
// Testbench for cpu.v (Task 5) -- replays mult4.rom and checks the
...
// 26-instruction ROM is fetched/executed a total of 48
// distinct cpu_out values' worth of times (i.e. more than 26
// Fetches happen overall, because of the loop).
//
// mult4.out is a CHANGE LOG just like every previous task's .out file:
...
module cpu_mult4_tb;
    ...
    // The 48-row golden trace from mult4.out, each row packed as
    // {PC[15:0], IR[15:0], RZ[15:0]}.
    reg [47:0] expected [0:47];

    initial begin
        expected[0] = 48'h000000000000;
        expected[1] = 48'h000104920000;
        expected[2] = 48'h000104920002;
        expected[3] = 48'h00026d900002;
        expected[4] = 48'h00056d900002;
        expected[5] = 48'h000605220002;
        expected[6] = 48'h00076da00002;
        expected[7] = 48'h000a6da00002;
        expected[8] = 48'h000b15b00002;
        expected[9] = 48'h000b15b00000;
        expected[10] = 48'h000c16d00000;
        expected[11] = 48'h000d16210000;
        expected[12] = 48'h000e45400000;
        expected[13] = 48'h001045400000;
        expected[14] = 48'h00112c910000;
        expected[15] = 48'h00112c910004;
        expected[16] = 48'h00124e500004;
        expected[17] = 48'h00124e500000;
        expected[18] = 48'h001335210000;
        expected[19] = 48'h001335210001;
        expected[20] = 48'h001402d20001;
        expected[21] = 48'h00154e500001;
        expected[22] = 48'h00114e500001;
        expected[23] = 48'h00124e500001;
        expected[24] = 48'h000e4e500001;
        expected[25] = 48'h000f4e500001;
        expected[26] = 48'h000b4e500001;
        expected[27] = 48'h000c16d00001;
        expected[28] = 48'h000c16d00000;
        expected[29] = 48'h000d16210000;
        expected[30] = 48'h000d16210001;
        expected[31] = 48'h000e45400001;
        expected[32] = 48'h000f4e500001;
        expected[33] = 48'h000f4e500000;
        expected[34] = 48'h001001b10000;
        expected[35] = 48'h001001b10004;
        expected[36] = 48'h00112c910004;
        expected[37] = 48'h00112c910008;
        expected[38] = 48'h00124e500008;
        expected[39] = 48'h00124e500000;
        expected[40] = 48'h001335210000;
        expected[41] = 48'h001402d20000;
        expected[42] = 48'h00154e500000;
        expected[43] = 48'h00164d010000;
        expected[44] = 48'h00184d01ffff;
        expected[45] = 48'h001905b0ffff;
        expected[46] = 48'h001905b00004;
        expected[47] = 48'h001a43800004;
    end
    ...
    initial begin
        ...
        while (!halt && cycle_count < MAX_CYCLES) begin
            ...
            if (cpu_out !== prev_cpu_out) begin
                if (idx > 47) begin
                    errors = errors + 1;
                    $display("FAIL: unexpected extra cpu_out change at cycle %0d: got %h (only 48 changes expected)",
                              cycle_count, cpu_out);
                end else begin
        ...
        if (idx != 48) begin
            errors = errors + 1;
            $display("FAIL: expected 48 distinct cpu_out values before halt, observed %0d", idx);
        end

        if (errors == 0)
            $display("ALL %0d EXPECTED CPU_OUT TRANSITIONS MATCHED -- tb_cpu_mult4 looks correct", idx);
        else
